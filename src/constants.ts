...
export const EXCLUDED_SURVIVOR_TRAITS = [
  "破译完美判定额外增长进度",
  "校准概率",
  "校准区域",
  "透视",
...
export const MOCK_CHARACTERS: Character[] = [
  {
    ...
    skills: [
      {
        name: "破译密码机",
        description: "求生者的核心目标，破译5台密码机以开启大门。",
      },
...
export const DEFAULT_TAG_CONFIG = [
  {
    name: "移动",
    color: "#06b6d4",
    keywords: ["移动", "移速", "速度", "冲刺", "加速", "距离"],
  },
  {
    name: "破译",
    color: "#10b981",
    keywords: ["破译", "修机", "密码机", "进度", "校准"],
  },
  {
    name: "交互",
    color: "#f59e0b",
    keywords: ["交互", "翻窗", "翻板", "窗板", "放板", "跨越", "牵制"],
  },
  {
    name: "治疗",
    color: "#ef4444",
    keywords: ["治疗", "自愈", "倒地", "受伤", "愈合", "救人"],
  },
];
